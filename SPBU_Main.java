        ...
        do { 
            ...
            switch (pilihan) {
                ...
                case 3:
                    ...
                    break;
                case 4: 
                    kendaraan dilayani = antrianKendaraan.layaniAntrian();  // gunakan variabel yang benar
                    if (dilayani != null) {
                        System.out.println("Petugas Melayani " + dilayani.platNomor );
                        System.out.print("Masukkan Nama BBM: ");
                        String namaBBM = sc.nextLine(); // gunakan sc, bukan input
                        ...
                        // Buat objek BBM
                        BBM bbm = new BBM(namaBBM, hargaPerLiter, (int) jumlahLiter);

                        // Buat transaksi pengisian
                        TransaksiPengisian transaksi = new TransaksiPengisian(dilayani, bbm, jumlahLiter);

                        // Masukkan ke antrian transaksi
                        antrianTransaksi.enqueue(transaksi); // gunakan variabel yang benar
